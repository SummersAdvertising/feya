...
class Admin::EntriesControllerTest < ActionController::TestCase
  ...
  test "should create admin_entry" do
    assert_difference('Admin::Entry.count') do
      post :create, admin_entry: { article_id: @admin_entry.article_id, status: @admin_entry.status, title: @admin_entry.title }
    end
  ...
  test "should update admin_entry" do
    put :update, id: @admin_entry, admin_entry: { article_id: @admin_entry.article_id, status: @admin_entry.status, title: @admin_entry.title }
    assert_redirected_to admin_entry_path(assigns(:admin_entry))
  end
