editor.p = {
	...
	initPost: function(){
		...
		table.append($('<tr>').append($('<td width="95%" class="text">').append(text))
							  .append($('<td width="5%" class="send">').append('<input name="" type="button" class="editorAdd">')));
	...
	edit: function(paragraphContainer, controlPanel){
		...
		var editbtnBar = $("<div>");
		editbtnBar.addClass("tool-after").append(save).append(cancel);
	...
	bindControl: function(paragraphBox){
		...
		controlPanel.addClass("controlPanel tool-before tool");
